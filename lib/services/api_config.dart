...
class ApiConfig {
  ...
  static String get eventRegisterTeam => '$baseUrl/events/register/team';
  static String eventById(String id) => '$baseUrl/events/$id';
  static String cancelRegistration(String id) => '$baseUrl/events/register/$id';
  static String eventTeam(String registrationId) =>
      '$baseUrl/events/team/$registrationId';
  ...
  // ── Payments ──────────────────────────────────────────────────────────────
  /// Official Paytm payment portal link for Technoplanet
  static const String paymentGatewayUrl = 'https://p.ppsl.io/PYTMPS/R73Djk';
  ...
  static String paymentById(String paymentId) => '$baseUrl/payment/$paymentId';
  ...
  static String feedbackForEvent(String eventId) =>
      '$baseUrl/feedback/$eventId';
  ...
  // ── Faculty Mail ──────────────────────────────────────────────────────────
  /// POST — send mail to event participants
  static String get facultyMailSend => '$baseUrl/faculty/mail/send';

  // ── Event Gallery ────────────────────────────────────────────────────────
  /// GET — public event gallery (paginated)
  static String eventGallery(String eventId) =>
      '$baseUrl/events/$eventId/gallery';

  /// POST — faculty upload gallery images
  static String facultyEventGalleryUpload(String eventId) =>
      '$baseUrl/faculty/events/$eventId/gallery';

  /// DELETE / PATCH — faculty manage gallery image
  static String facultyEventGalleryImage(String eventId, String imageId) =>
      '$baseUrl/faculty/events/$eventId/gallery/$imageId';
  ...
  static String get volunteerParticipants =>
      '$baseUrl/coordinator/participants';
  ...
  static String get adminBlockedUsers =>
      '$baseUrl/admin/security/blocked-users';
