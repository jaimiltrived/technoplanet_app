...
import 'faculty_event_detail.dart';
...
class _FacultyDashboard extends ConsumerWidget {
                ...
                data: (myEvents) {
                  ...
                  return SliverList(
                    delegate: SliverChildListDelegate([
                      _buildStatsGrid(myEvents.length, totalParticipants, pendingRanks),
  ...
  Widget _buildStatsGrid(int events, int participants, int pending) {
    final stats = [
              ...
              child: InkWell(
                ...
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (_) => FacultyEventDetailScreen(
                        event: e,
                        user: user,
                      ),
                    ),
