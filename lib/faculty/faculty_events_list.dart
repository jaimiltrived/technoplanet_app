        ...
        child: InkWell(
          ...
          onTap: () {
            Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => FacultyEventDetailScreen(
                  event: event,
                  user: user,
                ),
              ),
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        Row(
                          children: [
                            _chip(event.category.label, Colors.white.withValues(alpha: 0.3), Colors.white),
                            const Spacer(),
                ...
                Wrap(
                  ...
                  children: [
                    ...
                    ElevatedButton.icon(
                      ...
                      icon: const Icon(Icons.group_rounded, size: 15),
