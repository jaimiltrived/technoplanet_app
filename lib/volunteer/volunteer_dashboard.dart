    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            'Track attendees, mark attendances, and manage on-ground event operations seamlessly.',
            style: TextStyle(
              ...
              onPressed: () {
                if (onNavigateTab != null) {
                  ...
                  Navigator.of(context).push(
                    MaterialPageRoute(
                      builder: (_) => VolunteerParticipantsScreen(user: user),
                    ),
                  );
                }
              },
        ...
        children: [
          ...
          SizedBox(
            ...
            child: ElevatedButton.icon(
              ...
              label: const Text('View Attendances', style: TextStyle(fontSize: 13, fontWeight: FontWeight.bold)),
              onPressed: () {
                Navigator.of(context).push(
                  MaterialPageRoute(
